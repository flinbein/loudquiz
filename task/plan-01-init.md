...
- [ ] Логика чередования команд: активная команда меняется каждый раунд/блиц, равное число заданий у обеих
- [ ] Пропуск нечётного задания при неравном распределении
- [ ] State filtering для dual: противник видит текст вопроса, активная команда (кроме капитана) — нет
- [ ] Отображение «чья сейчас очередь» на хосте и у игроков
...
- [ ] `PlayerFinale` — очки, сообщение победы/благодарности, кнопка «Играть снова»
- [ ] Фаза `finale` в state machine, переход из последнего раунда/блица
