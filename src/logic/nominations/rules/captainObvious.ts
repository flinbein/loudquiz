...
export const captainObviousRule: NominationRule = {
  id: "captainObvious",
  emoji: "🧐",
  titleKey: "finale.nomination.captainObvious.title",
  descriptionKey: "finale.nomination.captainObvious.description",
  tieStrategy: "skip",
  compute(ctx) {
