...
describe("getNextPhaseAfterReview", () => {
  it("returns round-captain when unplayed questions remain", () => {
    const history: RoundResult[] = [
      { type: "round", teamId: "red", captainName: "A", questionIndex: 0, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
    ];
  ...
  it("returns blitz-captain when all questions played and blitz tasks exist", () => {
    const history: RoundResult[] = [
      { type: "round", teamId: "red", captainName: "A", questionIndex: 0, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "round", teamId: "red", captainName: "B", questionIndex: 1, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
    ];
  ...
  it("dual: skips last question when odd total (9 questions, 2 teams → 8 played)", () => {
    const history: RoundResult[] = Array.from({ length: 8 }, (_, i) => ({
      type: "round" as const, teamId: i % 2 === 0 ? "red" : "blue", captainName: "P", questionIndex: i, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [],
    }));
  ...
  it("dual: skips last blitz when odd total", () => {
    const history: RoundResult[] = [
      { type: "round", teamId: "red", captainName: "A", questionIndex: 0, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "blitz", teamId: "red", captainName: "B", blitzTaskIndex: 0, score: 200, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "blitz", teamId: "blue", captainName: "C", blitzTaskIndex: 1, score: 200, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
    ];
  ...
  it("single 9q/2b: after 8th question → round-captain (question 9 still available)", () => {
    const history: RoundResult[] = Array.from({ length: 8 }, (_, i) => ({
      type: "round" as const, teamId: "none", captainName: "P", questionIndex: i, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [],
    }));
  ...
  it("dual 2q/2b: after 1st question → round-captain (2nd question for other team)", () => {
    const history: RoundResult[] = [
      { type: "round", teamId: "red", captainName: "P", questionIndex: 0, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
    ];
  ...
  it("single 2q/2b: after 1st question → round-captain (2nd question available)", () => {
    const history: RoundResult[] = [
      { type: "round", teamId: "none", captainName: "P", questionIndex: 0, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
    ];
  ...
  it("dual 0q/5b: after 4th blitz → finale (odd blitz skipped)", () => {
    const history: RoundResult[] = Array.from({ length: 4 }, (_, i) => ({
      type: "blitz" as const, teamId: i % 2 === 0 ? "red" : "blue", captainName: "P", blitzTaskIndex: i, score: 200, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [],
    }));
  ...
  it("single 0q/5b: after 4th blitz → blitz-captain (5th blitz available)", () => {
    const history: RoundResult[] = Array.from({ length: 4 }, (_, i) => ({
      type: "blitz" as const, teamId: "none", captainName: "P", blitzTaskIndex: i, score: 200, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [],
    }));
...
describe("getPlayedQuestionIndices", () => {
  ...
  it("returns indices of played round questions", () => {
    const history: RoundResult[] = [
      { type: "round", teamId: "red", captainName: "A", questionIndex: 0, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "round", teamId: "red", captainName: "B", questionIndex: 3, score: 200, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "blitz", teamId: "red", captainName: "C", blitzTaskIndex: 0, score: 50, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
    ];
...
describe("blitz history helpers", () => {
  it("getPlayedBlitzTaskIds returns only blitz results", () => {
    const history: RoundResult[] = [
      { type: "round", teamId: "red", captainName: "A", questionIndex: 0, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "blitz", teamId: "red", captainName: "B", blitzTaskIndex: 0, score: 200, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "blitz", teamId: "red", captainName: "C", blitzTaskIndex: 2, score: 300, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
    ];
  ...
  it("getNextPhaseAfterReview returns finale when all blitz played", () => {
    const history: RoundResult[] = [
      { type: "round", teamId: "red", captainName: "A", questionIndex: 0, score: 100, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: 0, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "blitz", teamId: "red", captainName: "B", blitzTaskIndex: 0, score: 200, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
      { type: "blitz", teamId: "red", captainName: "C", blitzTaskIndex: 1, score: 200, jokerUsed: false, playerResults: [], difficulty: 100, topicIndex: -1, bonusTimeApplied: false, bonusTime: 0, bonusTimeMultiplier: 1, groups: [] },
    ];
