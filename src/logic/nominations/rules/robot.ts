...
export const robotRule: NominationRule = {
  id: "robot",
  emoji: "🤖",
  titleKey: "finale.nomination.robot.title",
  descriptionKey: "finale.nomination.robot.description",
  tieStrategy: "all",
  compute(ctx) {
