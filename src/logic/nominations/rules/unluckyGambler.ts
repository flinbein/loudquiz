...
export const unluckyGamblerRule: NominationRule = {
  id: "unluckyGambler",
  emoji: "🎰",
  titleKey: "finale.nomination.unluckyGambler.title",
  descriptionKey: "finale.nomination.unluckyGambler.description",
  tieStrategy: "all",
  compute(ctx) {
